 ...
 */
public class SingleWarnBugViewBinder extends ItemViewProvider<Warn, SingleWarnBugViewBinder.ViewHolder> {
    public Context context;
    public SingleWarnBugViewBinder(Context context) {
    ...
    protected ViewHolder onCreateViewHolder(@NonNull LayoutInflater inflater, @NonNull ViewGroup parent) {
        ViewDataBinding dataBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()),
                R.layout.item_single_warn_bug_list, parent, false);
    ...
    protected void onBindViewHolder(@NonNull ViewHolder viewHolder, @NonNull final Warn warn) {
        ...
        ItemSingleWarnBugListBinding binding = (ItemSingleWarnBugListBinding) viewHolder.getBinding();
